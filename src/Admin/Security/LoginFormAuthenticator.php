...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException('Zadali jste nesprávný email!');
        }
    ...
    public function checkCredentials($credentials, UserInterface $user)
    {
        ...
        else throw new CustomUserMessageAuthenticationException('Nesprávné heslo!');
    }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('add_game'));
    }
