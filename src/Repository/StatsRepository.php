...
class StatsRepository
{
    ...
    {
        $this->updateStatRefereeMatches();
        $this->updateStatAr1Matches();
        $this->updateStatAr2Matches();
        $this->updateStatAr1AndAr2Matches();
        $this->updateStatOfficialMatches();

        $this->updateStatRefereeRed();
        $this->updateStatRefereeRedOffence();
        $this->updateStatRefereeYellow();
        $this->updateStatRefereeYellowFirst();
        $this->updateStatRefereeCardsMinutes();

        $this->updateStatAssessorMatches();
        $this->updateStatAssessorRed();
        $this->updateStatAssessorYellow();

        $this->updateStatRefereeAr();
        $this->updateStatOfficialOfficial();
        $this->updateStatRefereeAssessor();
        $this->updateStatOfficialAssessor();
        $this->updateStatOfficialTeam();
        $this->updateStatOfficialHomeTeam();
        $this->updateStatAssessorTeam();
    }

    private function updateStatRefereeMatches()
    {
    ...
    private function updateStatAr1Matches()
    {
    ...
    private function updateStatAr2Matches()
    {
    ...
    private function updateStatAr1AndAr2Matches()
    {
    ...
    private function updateStatOfficialMatches()
    {
    ...
    private function updateStatRefereeRed()
    {
    ...
    private function updateStatRefereeRedOffence()
    {
    ...
    private function updateStatRefereeYellow()
    {
    ...
    private function updateStatRefereeYellowFirst()
    {
    ...
    private function updateStatRefereeCardsMinutes()
    {
    ...
    private function updateStatAssessorMatches()
    {
    ...
    private function updateStatAssessorRed()
    {
    ...
    private function updateStatAssessorYellow()
    {
    ...
    private function updateStatRefereeAr()
    {
    ...
    private function updateStatOfficialOfficial()
    {
    ...
    private function updateStatRefereeAssessor()
    {
    ...
    private function updateStatOfficialAssessor()
    {
    ...
    private function updateStatOfficialTeam()
    {
    ...
    private function updateStatOfficialHomeTeam()
    {
    ...
    private function updateStatAssessorTeam()
    {
